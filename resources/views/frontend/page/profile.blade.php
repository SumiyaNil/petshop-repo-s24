      ...
      <div class="col-lg-4">
        <div class="card mb-4">
          <div class="card-body text-align-center">
            ...
            <p class="text-muted mb-0">Name:{{auth('customerGuard')->user()->name}}</p>
            <p class="text-muted mb-0">Email:{{auth('customerGuard')->user()->email}}</p>
            <p class="text-muted mb-0">Phone:{{auth('customerGuard')->user()->number}}</p>
