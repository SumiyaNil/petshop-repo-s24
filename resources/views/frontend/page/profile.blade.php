        ...
        <div class="card mb-4">
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-sm-9">
                <p class="text-muted mb-0">{{auth('customerGuard')->user()->name}}</p>
              </div>
            </div>
            <hr>
            <div class="row">
              ...
              <div class="col-sm-9">
                <p class="text-muted mb-0">{{auth('customerGuard')->user()->email}}</p>
              </div>
            </div>
            <hr>
            <div class="row">
              ...
              <div class="col-sm-9">
                <p class="text-muted mb-0">{{auth('customerGuard')->user()->number}}</p>
              </div>
            </div>
            <hr>
            <div class="row">
