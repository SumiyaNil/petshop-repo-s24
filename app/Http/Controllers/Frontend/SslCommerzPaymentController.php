...
class SslCommerzPaymentController
{
    ...
    public function fosterPay($foster)
    {
        ...
        $post_data = array();
        $post_data['total_amount'] = $foster->price; # You cant not pay less than 10
        $post_data['currency'] = "BDT";
       
        $post_data['tran_id'] = $foster->id; // tran_id must be unique

        # CUSTOMER INFORMATION
        $post_data['cus_name'] = $foster->customer->name;
        $post_data['cus_email'] = $foster->customer->email;
        ...
        $post_data['cus_postcode'] = "";
        $post_data['cus_country'] = "Bangladesh";
        $post_data['cus_phone'] = $foster->customer->number;
        $post_data['cus_fax'] = "";
    ...
    public function success(Request $request)
    {
        ...
        $sslc = new SslCommerzNotification();
        //condition check if foster or not
       
        
        if($request->value_a=='foster')
        {
            $foster=Foster::find($order_id);
            ...
            if ($validation) {
                ...
                notify()->success('Foster service booked successfully.');
